...
module.exports = {
    ...
    execute: async (client, message, args, zetsu_embed) => {
     ...
     if(!data) return message.reply({ embeds: [zetsu_embed.setDescription(`> **Bu Kanalda Silinen Bir Mesaj Bulunmamakta!**`)] }).sil(5);
     client.true(message)
     return message.channel.send({ embeds: [zetsu_embed.addFields(
