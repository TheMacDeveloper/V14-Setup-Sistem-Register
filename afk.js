...
module.exports = {
    ...
    execute: async (client, message, args, zetsu_embed) => {
        ...
        return message.channel.send({ embeds: [zetsu_embed.setDescription(`> **${message.member} "${["www", ".com", "discord.gg", ".gg", "discord"].some(bes => reason.includes(bes)) ? `(Reklam)` : reason}" Sebebiyle AFK Moduna Giriş Yaptın!**`)] }).sil(5);
    }
}
